...
class DistrictMaitanceDetails extends StatelessWidget {
  const DistrictMaitanceDetails({Key? key, required this.maintanceModel})
      : super(key: key);
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      DistrictMySqlHelper.maintenanceVerification(
