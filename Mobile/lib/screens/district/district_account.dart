...
class DistrictAccount extends StatelessWidget {
  const DistrictAccount({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          SimpleTile(
            title: blocProvider.districtModel!.name,
            ontap: () {
            },
          ...
          SimpleTile(
            title: blocProvider.districtModel!.username,
            ontap: () {
            },
            firsticon: const Icon(
              Icons.person,
          ...
          SimpleTile(
            title: blocProvider.districtModel!.phone,
            ontap: () {
            },
            firsticon: const Icon(
              Icons.phone,
          ...
          SimpleTile(
            title: blocProvider.districtModel!.email,
            ontap: () {
            },
            firsticon: const Icon(
              Icons.email,
