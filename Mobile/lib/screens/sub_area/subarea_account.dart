...
class SubAreaAccount extends StatelessWidget {
  const SubAreaAccount({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          SimpleTile(
            title: blocProvider.subAreaModel!.name,
            ontap: () {},
          ...
          SimpleTile(
            title: blocProvider.subAreaModel!.username,
            ontap: () {},
            firsticon: const Icon(
              Icons.person,
              color: kPrimaryColor,
          ...
          SimpleTile(
            title: blocProvider.subAreaModel!.phone,
            ontap: () {},
            firsticon: const Icon(
              Icons.phone,
              color: kPrimaryColor,
          ...
          SimpleTile(
            title: blocProvider.subAreaModel!.email,
            ontap: () {},
            firsticon: const Icon(
              Icons.email,
              color: kPrimaryColor,
