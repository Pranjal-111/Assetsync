...
import 'package:assetsync/screens/state/state_sub_area_asstes.dart';
...
class StateSubAreaList extends StatelessWidget {
  final int districtid;
  const StateSubAreaList({Key? key, required this.districtid})
      : super(key: key);
