...
class StateAccount extends StatelessWidget {
  const StateAccount({Key? key}) : super(key: key);
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          SimpleTile(
            title: blocProvider.stateModel!.name,
            ontap: () {
            },
          ...
          SimpleTile(
            title: blocProvider.stateModel!.username,
            ontap: () {
            },
            firsticon: const Icon(
              Icons.person,
          ...
          SimpleTile(
            title: blocProvider.stateModel!.phone,
            ontap: () {
            },
            firsticon: const Icon(
              Icons.phone,
          ...
          SimpleTile(
            title: blocProvider.stateModel!.email,
            ontap: () {
            },
            firsticon: const Icon(
              Icons.email,
