...
import NavbarOfAdmin from "../Admin Panel/NavbarOfAdmin";
...
const AdminAdministration = () => {
  ...
  const GET_API_URL = "https://assetasync.herokuapp.com/api/admin/getstate";
  ...
  async function PostData() {
    ...
    var admin_id = dataa.id;

    let item = { name, phone, email, admin_id };
    let result = await fetch(
      "https://assetasync.herokuapp.com/api/admin/createState",
      {
        method: "POST",
        headers: {
