...
const NavbarOfDistrict = () => {
  ...
  const logouthandler = (e) => {
    e.preventDefault();
    localStorage.removeItem("districtauth");
    setlogout(true);
  };
  ...
  return (
    <Container>
      ...
      <Menu>
        <NavLink>
          <Link to="/district-statistics">Statistics</Link>
        </NavLink>
        <NavLink>
          <Link to="/district-administration">Administration</Link>
        </NavLink>
        <NavLink>
          <Link to="/district-maintenance">Maintenance</Link>
        </NavLink>
        <NavLink>
          <Link to="/district-verification">Verification</Link>
        </NavLink>
...
export default NavbarOfDistrict;
