...
const NavbarOfBlock = () => {
  ...
  useEffect(() => {
    if (!localStorage.getItem("blockauth")) {
      history("/login");
    }
  }, [logout]);
  ...
  return (
    <Container>
      ...
      <Menu>
        <NavLink>
          <Link to="/block-statistics">Statistics</Link>
        </NavLink>
        <NavLink>
          <Link to="/block-addAsset">Add Asset</Link>
        </NavLink>
        <NavLink>
          <Link to="/block-addAsset-verification">Verification</Link>
        </NavLink>
        <NavLink
          aria-describedby={id}
          variant="contained"
